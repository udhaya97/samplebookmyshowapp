...
<div class="container">
<h3>Add Place</h3>
<form:form action="/savplace" method="post" modelAttribute="place" enctype="multipart/form-data">
...
<tr>
<td>Place Name</td><td><form:input path="pName" name="pName" required="required"/></td></tr>
